...
class AdminSpProductController extends Controller
{
    public function index(Request $request)
    {
        return view('admin.product.spProductIndex',['id' => $request->id]);
    }
    ...
    public function getlist(Request $request)
    {
        ...
        return Datatables::of($spProducts)
            ...
            ->addColumn('action', function ($spProducts) {
                $string = "";
                $string .= '<a data-tooltip="tooltip" title="In Qr-Code" href="' . route('admin.print.qrcode', $spProducts->id) . '" class="btn btn-info btn-xs"><i class="fa fa-qrcode"></i></a>';
                return $string;
            })
            ->make(true);
    }
    ...
    public function printQrcode($id)
    {
        ...
        return view('admin.product.printQrcode',['url' => $url]);
    }
}
