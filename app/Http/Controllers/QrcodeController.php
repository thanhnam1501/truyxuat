...
class QrcodeController extends Controller
{
    ...
    public function getlist()
    {
        if (Auth::guard('web')->user()->type == 7) {
            ...
            $data = DB::table('qr_codes')
                ...
                ->whereIn('qr_codes.company_id', $companyIdList)
    ...
    public function getFormCreate()
    {
        if (Auth::guard('web')->user()->type == 7) {
            ...
            $company = Company::whereIn('id', $companyIdList)->get();
    ...
    public function getListHistory(Request $request)
    {
        if (Auth::guard('web')->user()->type == 7) {
            ...
            $data = QrcodeHistory::whereIn('company_id', $companyIdList)->orderBy('created_at', 'desc')->get();
        } else {
