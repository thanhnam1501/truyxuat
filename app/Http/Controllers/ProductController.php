...
class ProductController extends Controller
{
    ...
    public function getFormCreate()
    {
        ...
        if ($limit >= $company->product_limit) {
            ...
            return view('user.product.AddProduct', ['users' => $user]);
        }
    }
    ...
    public function index()
    {
        ...
        $messageError = '';
        if ($now > $date) {
            $messageError = "Thời gian sử dịch dịch vụ của bạn đã hết! Liên hệ với quản trị viên để gia hạn thêm! Xin cảm ơn!";
        }
        return view('user.product.index', ['messageError' => $messageError]);
    }
    ...
    public function getlist()
    {
        ...
        return Datatables::of($products)
            ...
            ->addColumn('action', function ($products) {
                ...
                $string .= '<a data-tooltip="tooltip" title="Danh sách thu hoạch" href="' . route('sp.product.index', $products->id) . '" class="btn btn-warning btn-xs"><i class="fa fa-list"></i></a>';
