...
@if(!empty($data) && $data->status == 1)
    ...
    <div class="x_panel" @if($expire_date == 0) style="background-color: #fdfdb5" @else style="background-color: #f5afaf" @endif>
        <li>
            Ngày thu hoạch: {{$data['harvest_date']}}
        </li>
        <li>
            Hạn sử dụng: {{$data['expiration_date']}}
        </li>
    </div>
    <div>
        <div>
