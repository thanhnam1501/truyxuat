  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" data-type='0' data-user_id="" id="create-user-btn">Lưu</button>
      </div>
    </div>
  </div>
</div>
      ...
      <div class="modal-body">
				...
				<div class="form-group">
					<div class="input-group input-group-lg">
							...
							<span class='form-control' id="avatar-detail"></span>
					</div>
				</div>
				<div class="form-group">
					<div class="input-group input-group-lg">
...
<script type="text/javascript" src="{{mix('build/js/account-user.js')}}"></script>
...
<script type="text/javascript">
	...
	function editModal(id)
	{
			...
			$.ajax({
					type: "GET",
					url: app_url + 'admin/account-user/'+id+'/edit',
