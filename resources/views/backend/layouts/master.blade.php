                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-profile">
                        <a href="#" class="profile-mini">
                            <img src="{{asset('assets/images/users/avatar.jpg')}}" alt="Admin"/>
                        </a>
                        <div class="profile">
                    ...
                    <li>
                        <a href="#"><span class="fa fa-lock"></span> <span class="xn-text">Vai trò</span></a>
                    </li> 
                    <li>
                        <a href="#"><span class="fa fa-shield"></span> <span class="xn-text">Quyền hạn</span></a>
                    </li> 
        ...
        <div class="message-box animated fadeIn" data-sound="alert" id="mb-signout">
            <div class="mb-container">
                <div class="mb-middle">
                    ...
                    <div class="mb-footer">
                        <div class="pull-right">
                            <a href="pages-login.html" class="btn btn-success btn-lg">Có</a>
