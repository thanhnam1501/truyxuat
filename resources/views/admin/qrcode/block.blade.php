     ...
     <form id="form-saveBlockProduct" action="{{route('qrcode.saveBlockProduct')}}" method="POST">
      ...
      <div class="">
        <div class="box-header with-border">
          ...
          <h3 class="text-center help">{{$block->company->name}} | GUID: {{$block->id}} | Serial: [{{$block->start}}-{{$block->end}}]</h3>
        ...
        <div class="box-footer text-center">
          <button type="button" class="btn btn-primary " onclick="saveBlockProduct()">Lưu sản phẩm</button>
      ...
      <div class="modal-body">
        <form id="form-product" action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-9">
                  ...
                  <!-- /.form-group -->
                  <input type="hidden" name="addProduct_company_id" id="addProduct_company_id" value="{{$block->company_id}}">
                  <input type="hidden" name="addProduct_id" id="addProduct_id" value="{{$block->id}}">
                  <!-- /.form-group -->
                </div>
                <!-- /.col -->
              </div>
          ...
          <div class="modal-footer">
            <button type="submit" class="btn btn-primary" data-dismiss="">Save</button>
          </div>
        </form>
      </div>
    </div>
